...
export const replayXhrResponder: HackerModule = {
  ...
  XMLHttpRequest.prototype.open.__websnapOriginal = originalOpen;
  XMLHttpRequest.prototype.send.__websnapOriginal = originalSend;
`
};
